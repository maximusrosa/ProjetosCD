...
ARCHITECTURE structure OF mbr_mux8x1_8b IS
...
SIGNAL \inst|inst2|inst3~2_combout\ : std_logic;
SIGNAL \inst|inst2|inst3~3_combout\ : std_logic;
...
SIGNAL \inst|inst2|inst3~1_combout\ : std_logic;
SIGNAL \c[2]~input_o\ : std_logic;
SIGNAL \inst|inst2|inst3~4_combout\ : std_logic;
...
\inst|inst2|inst3~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \inst|inst2|inst3~2_combout\ = (\c[1]~input_o\ & (((\c[0]~input_o\)))) # (!\c[1]~input_o\ & ((\c[0]~input_o\ & ((\e[1]~input_o\))) # (!\c[0]~input_o\ & (\e[0]~input_o\))))
...
PORT MAP (
	...
	datac => \e[1]~input_o\,
	datad => \c[0]~input_o\,
	combout => \inst|inst2|inst3~2_combout\);

-- Location: LCCOMB_X18_Y2_N6
\inst|inst2|inst3~3\ : cycloneiv_lcell_comb
-- Equation(s):
-- \inst|inst2|inst3~3_combout\ = (\c[1]~input_o\ & ((\inst|inst2|inst3~2_combout\ & (\e[3]~input_o\)) # (!\inst|inst2|inst3~2_combout\ & ((\e[2]~input_o\))))) # (!\c[1]~input_o\ & (((\inst|inst2|inst3~2_combout\))))
...
PORT MAP (
	...
	datab => \e[3]~input_o\,
	datac => \e[2]~input_o\,
	datad => \inst|inst2|inst3~2_combout\,
	combout => \inst|inst2|inst3~3_combout\);
...
-- Equation(s):
-- \inst|inst2|inst3~0_combout\ = (\c[1]~input_o\ & ((\e[6]~input_o\) # ((\c[0]~input_o\)))) # (!\c[1]~input_o\ & (((\e[4]~input_o\ & !\c[0]~input_o\))))
...
\inst|inst2|inst3~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \inst|inst2|inst3~1_combout\ = (\inst|inst2|inst3~0_combout\ & (((\e[7]~input_o\) # (!\c[0]~input_o\)))) # (!\inst|inst2|inst3~0_combout\ & (\e[5]~input_o\ & ((\c[0]~input_o\))))
...
PORT MAP (
	dataa => \e[5]~input_o\,
	datab => \e[7]~input_o\,
	datac => \inst|inst2|inst3~0_combout\,
	datad => \c[0]~input_o\,
	combout => \inst|inst2|inst3~1_combout\);
...
\inst|inst2|inst3~4\ : cycloneiv_lcell_comb
-- Equation(s):
-- \inst|inst2|inst3~4_combout\ = (\c[2]~input_o\ & ((\inst|inst2|inst3~1_combout\))) # (!\c[2]~input_o\ & (\inst|inst2|inst3~3_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|inst2|inst3~3_combout\,
	datab => \inst|inst2|inst3~1_combout\,
	datad => \c[2]~input_o\,
	combout => \inst|inst2|inst3~4_combout\);
